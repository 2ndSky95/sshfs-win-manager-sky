export default {
  ...
  settings: {
    ...
    passkey1d: '1 day',
    passkey2d: '2 days',
    startupWithOS: 'Start with {os}',
    displayTrayMessageOnClose: 'Tray message on close',
    closeWindowQuits: 'Close quits the app',
    startInTray: 'Start in tray',
    startInMenuBar: 'Start in menu bar',
    ...
    connectEncryptPrompt: 'The password of this connection is stored in plain text although the passkey is enabled.\n\nEncrypt it with your passkey now?\nYes = enter or set your passkey. No = connect without the passkey.',
